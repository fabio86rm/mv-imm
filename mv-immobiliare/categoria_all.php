...
<div class=" banner-buying">
	<div class=" container">
		<h3><span><?php echo $nomeCategoria; ?></span></h3> 
		<div class="clearfix"> </div>      		
	</div>
</div>
<!-- banner inizale end -->	
	...
	<div class="buy-single">
		<div class="box-sin">
			<div class="col-md-9 single-box">
				...
				$sqlAnnunciRecenti= "SELECT A.idAnnuncio, A.citta, A.indirizzo, A.prezzo, A.num_stanze, C.nomeCategoria, A.descrizione, I.path_immagine ".
				...
				try{
				    if($resultAnnunciRecenti = $mysqli->query($sqlAnnunciRecenti)){
						...
						while($rowAnnuncio = $resultAnnunciRecenti->fetch_array(MYSQLI_ASSOC)) {
						    ...
						    $i++;
						    $puntiniDescrizione = "";
						    if(strlen($rowAnnuncio['descrizione'])>240){
						        $puntiniDescrizione = "...";
						    }
							echo '
				<div class="box-col">
					...
					<div class="  col-sm-5 middle-side">
					     ...
					     <p><span class="bath" style="margin:0%">Prezzo </span>: <span class="two">&#8364; '.number_format($rowAnnuncio['prezzo'],2,",",".").'</span></p>
					     <p><span class="bath2" style="margin:0%">Citt&agrave </span>: <span class="two">'.$rowAnnuncio['citta'].'</span></p>
					     <p><span class="bath3" style="margin:0%">Indirizzo </span>:<span class="two">'.$rowAnnuncio['indirizzo'].'</span></p>
					     <p><span class="bath4" style="margin:0%">Stanze </span>: <span class="two">'.$rowAnnuncio['num_stanze'].'</span></p>
						 <p>'.substr($rowAnnuncio['descrizione'],0,240).$puntiniDescrizione.'</p>				 
